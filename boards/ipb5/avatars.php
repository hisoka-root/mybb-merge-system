 ...
 *
 * IPS5 Avatar Converter - SKELETON
 * TODO: Verify all column names against a real IPS5 database
 * IPS5 may store avatar data differently
 */
...
class IPB5_Converter_Module_Avatars extends Converter_Module_Avatars {
	...
	{
		global $mybb;
		// IPS5 may store full URLs like IPS4 - reset the input
	...
	function import()
	{
		...
		// TODO: Verify core_members table and avatar columns in IPS5
	...
	function convert_data($data)
	{
		...
		// TODO: Verify avatar column names (pp_photo_type, pp_main_photo, pp_main_height, pp_main_width, pp_gravatar)
