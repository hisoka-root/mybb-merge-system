 ...
 *
 * IPS5 Forum Permissions Converter - SKELETON
...
class IPB5_Converter_Module_Forumperms extends Converter_Module_Forumperms {
	...
	function import()
	{
		...
		// TODO: Verify core_permission_index table in IPS5
	...
	function process_permission($data)
	{
		...
		// TODO: Verify permission column names (perm_view, perm_2, perm_3, perm_4, perm_5, perm_6)
		$perms = array(
			"perm_view"	=> "canview",
