...
/** @property IPB5_Converter $board */
class IPB5_Converter_Module_Forums extends Converter_Module_Forums {
	...
	function import()
	{
		...
		// TODO: Verify forums_forums table name in IPS5
		...
		while($forum = $this->old_db->fetch_array($query))
		{
			...
			// Update parent list.
			// TODO: Verify parent_id convention in IPS5 (-1 for top-level categories)
	...
	function convert_data($data)
	{
		...
		// TODO: Verify ALL column names below
	...
	/**
	 * Correctly associate any forums with their correct parent ids.
	 */
	function cleanup()
	{
		global $db;
